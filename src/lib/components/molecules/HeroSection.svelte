...
<div class="w-full flex justify-center relative z-10 hero-card-float mt-[-14rem] sm:mt-[-18rem] lg:mt-[-22rem]">
  <div class="w-full sm:w-11/12 lg:w-4/5 bg-transparent">
